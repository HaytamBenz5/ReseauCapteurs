        ...
        QGLWidget(parent)
{
    ...
    Axis_X_Color        =QColor::fromRgb(255,0  ,0  ,255);   // Color of the X axis : red
    Axis_Y_Color        =QColor::fromRgb(0  ,255,0  ,255);   // Color of the Y axis : green
    Axis_Z_Color        =QColor::fromRgb(0  , 0 ,255,255);  // Color of the Z axis : blue
